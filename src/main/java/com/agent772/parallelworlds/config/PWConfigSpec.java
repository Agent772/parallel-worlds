...
public final class PWConfigSpec {
    ...
    static {
        ...
        RESET_SCHEDULE = builder
                .comment("How often to rotate seeds: DAILY, WEEKLY, MONTHLY. Only applies if seedRotationEnabled=true.",
        ...
        PORTAL_CYCLE_ITEM = builder
                .comment("Item used to cycle the portal's target dimension (right-click portal frame).",
        ...
        DIMENSION_PARTICLE_COLORS = builder
                .comment("Portal particle color per dimension as 'mod:dimension=#RRGGBB'.",
        ...
        RESTRICTED_ITEMS = builder
                .comment("Restricted items in mining dimensions.",
        ...
        RESTRICTED_BLOCKS = builder
                .comment("Restricted blocks in mining dimensions (placement & interaction).",
        ...
        ASYNC_CHUNK_GEN_ENABLED = builder
                .comment("Enable async chunk noise computation for pre-generation and exploration.",
        ...
        PREVENT_EXPLORATION_SPAWN = builder
                .comment("Prevent players from respawning inside exploration dimensions.",
        ...
        DIMENSION_LOCKS = builder
                .comment("List of dimension lock entries as 'mod:dimension=mod:advancement_id'.",
